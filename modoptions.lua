...
--      },
	...
	{
		key    = "middle_crack",
		name   = "Crack middle of the map",
		desc   = "Does only the middle of the map get cracked.\nkey: middle_crack",
		type   = "bool",
		def    = false,
		section= "environment",
	},
	...
	},
	{
		key		= "comet_mode",
		name	= "Comet mode",
		desc	= "Do units fall or do rocks from the sky \nkey: comet_mode",
		type	= "list",
		def		= "rock",
		items={
			{key="rock", name="Rock", desc="Comets are rocks"},
			{key="unit", name="Unit", desc="Comets are units"},
		},
		section	= 'environment',
	},
	{
