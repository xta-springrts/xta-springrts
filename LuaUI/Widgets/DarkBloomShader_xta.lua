...
function widget:GetInfo()
	return {
		name      = "Test BloomShader (v0.3) (unstable) - Xta",
...
local glowAmplifier = 0.98		-- intensity multiplier when filtering a glow source fragment [1, n]
local blurAmplifier = 0.999		-- intensity multiplier when applying a blur pass [1, n] (should be set close to 1)
local illumThreshold = 0.1  	-- how bright does a fragment need to be before being considered a glow source? [0, 1]
local blurPasses = 1.0				-- how many iterations of (7x7) Gaussian blur should be applied to the glow sources?
