...
local configParams = {
	...
	filterParams = {0.2990, 0.5870, 0.1140, GetIntensityThreshold(0.2990, 0.5870, 0.1140,  0.8, 0.1, 0.1,  false),  0.5},

	blurKernelWeights = GetNormalizedKernelWeights(7, 0.0, 2.5, -6.0, 6.0),
	blurShaderPasses = 3,
}
...
function widget:GetInfo()
	return {
		name      = "gfx_bloomshader_redux.lua",
