...
local CanvasX,CanvasY = 1280,1024 --resolution in which the widget was made (for 1:1 size)
...
local Config = {
	tooltip = {
		...
		sx = 230,sy = 14*6+5*2, --background size
		
		fontsize = 14,
		
		margin = 5, --distance from background border
		
		cbackground = {0,0,0,0.1}, --color {r,g,b,alpha}
		cborder = {0,0,0,0},
