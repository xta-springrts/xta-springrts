...
--supreme islands
--{spawnBox={x1=800, z1=6300, x2=1600, z2=7000,} , unitNames = {["critter_duck"]=8, }, movement="RANDOM_PATROL",   },
--{spawnBox={x1=6560, z1=1200, x2=7160, z2=1600,} , unitNames = {["critter_duck"]=8, }, movement="RANDOM_PATROL",   },

--tumult
--{spawnBox={x1=3440, z1=3440, x2=3680, z2=3780,} , unitNames = {["critter_duck"]=3, }, movement="RANDOM_PATROL",   },

--trefoil

--{spawnBox={x1=5666, z1=4888, x2=8000, z2=6400,} , unitNames = {["critter_goldfish"]=10, }, movement="RANDOM_PATROL",   },
--{spawnBox={x1=3400, z1=300, x2=5000, z2=1500,} , unitNames = {["critter_goldfish"]=10, }, movement="RANDOM_PATROL",   },
...
["Vernal 3way 0.6.1"] = {
{spawnCircle = {x=math.random(1000,4000), z=math.random(1000,4000), r=300}, unitNames = {["critter_duck"]=6, },},
{spawnCircle = {x=math.random(1000,4000), z=math.random(1000,4000), r=300}, unitNames = {["critter_duck"]=6, },},
{spawnCircle = {x=math.random(1000,4000), z=math.random(1000,4000), r=300}, unitNames = {["critter_duck"]=6, },},
