...
local MaxStockpile = 6	-- set this to desired stockpile levels

function widget:GetInfo()
  return {
    name      = "Stockpiler (dynamic) - XTA",
    desc      = "Keeps stockpiled units at max " .. MaxStockpile .. " in storage, use /stockpilecount to adjust",
    author    = "BD",
    date      = "tomorrow",
    license   = "WTFPL",
    layer     = 0,
