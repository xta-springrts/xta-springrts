...
function widget:GetInfo()
	return {
		name      = "Expensive BloomShader (v0.3) (unstable) - Xta",
...
local glowAmplifier = 0.5		-- intensity multiplier when filtering a glow source fragment [1, n]
local blurAmplifier = 0.9410		-- intensity multiplier when applying a blur pass [1, n] (should be set close to 1)
