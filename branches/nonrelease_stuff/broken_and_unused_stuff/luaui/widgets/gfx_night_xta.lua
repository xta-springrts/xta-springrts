...
local nightColorMap        = {{0.2, 0.25, 0.5}, --midnight
                              {0.2, 0.25, 0.5},
                              {0.2, 0.25, 0.5},
...
local searchlightStrength  = 0                 --searchlight strength; <= 0 to turn off
...
local secondsPerDay        = 900                 --seconds per day
